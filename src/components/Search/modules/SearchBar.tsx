...
const SearchBar: FunctionComponent<SearchBarProps> = ({
  ...
  return (
    ...
    >
      <div className="relative h-fit tablet:h-10 w-full md:w-5/6 lg:w-3/5 flex flex-col tablet:flex-row gap-3 tablet:gap-2 items-center justify-center">
        <div
        ...
        <div className="relative w-full h-full flex items-center justify-center flex-col galaxy:flex-row gap-3">
          ...
          <div
            className={`relative tablet:absolute tablet:right-2 flex items-center justify-center rounded-sm font-bit text-brill uppercase text-center p-px active:scale-95 h-7 hover:opacity-70 cursor-pointer ${router.locale == "es" ? "w-fit" : "w-12"}`}
            id="borderSearch"
