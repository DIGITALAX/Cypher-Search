...
const Accounts: FunctionComponent<AccountsProps> = ({
  ...
  return (
    <>
      ...
      {cartListOpen && (
        <div
          className="absolute z-30 w-60 right-3 top-20 top-14 sm:top-24 tablet:top-16 h-72 rounded-sm bg-black flex flex-col p-3 border border-sol items-between justify-center"
          id="milestone"
        >
