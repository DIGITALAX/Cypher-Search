...
const SuccessCheckout: FunctionComponent<SuccessCheckoutProps> = ({
  ...
  return (
    <div className="inset-0 justify-center fixed z-50 bg-opacity-50 backdrop-blur-sm overflow-y-hidden grid grid-flow-col auto-cols-auto w-full h-auto">
      <div className="relative w-[30vw] h-[40vh] place-self-center bg-offBlack border border-white">
        <div className="relative w-full h-full flex flex-col gap-5 p-2">
          ...
          <div className="relative w-full h-fit items-center justify-center flex flex-col gap-3">
            ...
            <div
              className="relative w-2/3 h-full min-h-[25vh] flex items-center justify-center rounded-sm p-px cursor-pointer active:scale-95"
              onClick={() => {
