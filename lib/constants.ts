...
export const CHROMADIN_OPEN_ACTION: `0x${string}` =
  "0xe5b616C2f9E619294B0f566FAb319920aa72AA16";
export const LISTENER_OPEN_ACTION: `0x${string}` =
  "0xAF8CE9D122FB39a4cd98540ca37EFCdb98DcA0f7";
export const COIN_OP_OPEN_ACTION: `0x${string}` =
  "0x4fa29AF746cec6E373eB1238cE92445c969A77D8";
export const F3M_OPEN_ACTION: `0x${string}` =
  "0x97c094A20b5b5A8068e48720Ff78F0B30d5877bc";
